                ...
                <div id="baseTable">
                    ...
                    <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                        <thead>
                            ...
                            <tr>
	                            <th colspan="5"  style="text-align: center;"><h5>失业登记信息</h5></th>
	                        </tr>
	                        <tr>
	                        <td>失业登记日期</td>
	                        <td colspan="2"></td>
	                        ...
	                        <tr>
	                            <th colspan="5"  style="text-align: center;"><h5>待遇计发标准</h5></th>
	                        </tr>
	                        <tr>
	                         ...
	                         <tr>
	                            ...
	                            <tr>
	                            <td style="text-align: center;" rowspan="2">失业定期待遇核定</td>
	                            <td style="text-align: center;">核定月数</td>
	                             <td>
	                            	<input id="yearmyhightotal" name="yearmyhightotal" type="text" value=""
	                                       class="input-medium inputWidth"/>
	                            </td>
	                            <td style="text-align: center;" rowspan="2">待遇月标准</td>
	                            <td rowspan="2">
	                            	<input id="yearmyhightotal" name="yearmyhightotal" type="text" value=""
	                                       class="input-medium inputWidth"/>
	                            </td>
	                            ...
	                            <tr>
	                            <td  style="text-align: center;">已享受月数</td>
	                             <td>
	                            	<input id="yearmyhightotal" name="yearmyhightotal" type="text" value=""
	                                       class="input-medium inputWidth"/>
	                            </td>
