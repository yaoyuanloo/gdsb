                        ...
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            ...
                            <tr>
                                ...
                                <td ><input name="startDate" type="text" readonly="readonly"
                                 ...
                                 <th width="80">本地参结束始时间:</th>
                                <td ><input name="startDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td> --%>
                                 <th width="80">转出单位名称:</th>
                                <td></td>                 
                            </tr>
                            <tr>
                                <th width="80">参加工作时间:</th>
                                <td>   <input name="startWorkDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                                <th width="80">本地统筹时间:</th>
                                <td><input name="startjfDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                                <th width="80">本人首次缴费时间:</th>
                                <td >  <input name="ownfirstJfDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                                <th width="80">本人建立个人账户时间:</th>
                                <td ><input name="ownfirstJfsingerDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                             ...
                             <tr>
                                <th width="80">在本地缴费起始时间:</th>
                                <td>   <input name="startjflocalDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                                <th width="80">在本地缴费截至时间:</th>
                                <td><input name="endjflocalDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td>
                                <th width="80">在本地实际缴费月数:</th>
                                <td >  </td>
                                <th width="80">全部实际缴费月数:</th>
                                <td >  </td>
                               <%--  <th width="80">转移日期:</th>
                                <td ><input name="transterDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/></td> --%>
             ...
             <div class="accordion-group">
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            <tr>
                                <th width="80" colspan="2">个人账户基金储存额</th>
                                
                                <th width="80" colspan="4">视同缴费账户储存额</th>
                            
                                <th width="80" colspan="2">地方养老金储存额</th>
                                
                                 <th width="80" >有省外转入的统筹基金转移额</th>
                               
                                <th width="80" >转移基金总额</th>
