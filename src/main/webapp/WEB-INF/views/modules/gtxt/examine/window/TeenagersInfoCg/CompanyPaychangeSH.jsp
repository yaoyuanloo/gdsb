...
<html>
<head>
    <title>窗口审核详细--未成年单位缴费信息变更</title>
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner " style="padding: 0;text-align: center;">
                       <table id="contentTable"
						...
						<thread>
						    <tr>
                                <th colspan="4" style="text-align:left;"  class="accordion-toggle">基本信息</th>
                            </tr>
							<tr>
							<td width="25%">单位编号：<input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                                                        class="input-medium inputWidth"/></td>
			                <td width="25%">单位名称：<input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                                                        class="input-medium inputWidth"/></td>
							<td width="25%">管理部门</td>
							<td width="25%"><select id="sqr" name="sqr" class="input-medium selectWidth">
                                <option value="0" selected="selected">狮山劳动保障事务所</option>
                            ...
                            <tr>
                                ...
                                <td><select id="sqr" name="sqr" class="input-medium selectWidth">
                                    <option value="0" selected="selected">否（已出生）</option>
                                ...
                                <button style="margin-top:-10px;" >读卡</button>
                            ...
                            <td>人员类别</td>
                            <td><select id="sqr" name="sqr" class="input-medium selectWidth">
                                <option value="0" selected="selected">普通人员</option>
                            ...
                            <tr>
                                <td>缴费开始年月</td>
                                <td >  <input name="starthospitaldate" type="text" readonly="readonly"
                         ...
                         <tr>
                                <td>户籍编号</td>
                                <td><select id="sqr" name="sqr" class="input-medium selectWidth">
                                    <option value="0" selected="selected">农民</option>
                                </select></td>
                                <td>户籍性质</td>
                                <td><select id="sqr" name="sqr" class="input-medium selectWidth">
                            ...
                            <tr>
                                <td>征集年度</td>
                                <td><input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                                           class="input-medium inputWidth" value="2016"/></td>
                                <td>参保状态</td>
                                <td>  <input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                                             class="input-medium inputWidth" value="参保"/></td>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th colspan="4" style="text-align:left;">缴费信息</th>
                                </tr>
            ...
            <center>
                <div class="breadcrumb" style="margin-top: 3px; margin-right: 10px;">
                    ...
                    <button type="button" id="lrfpxx" onclick="" class="btn btn-warning"
                            ...
                            class="icon-card"></i>&nbsp;读身份证
                    </button> <button type="button" id="lrfpxx" onclick="" class="btn btn-warning"
                                      style="width: 110px; padding-left: 3px; padding-right: 3px;"><i
                        class="icon-card"></i>&nbsp;读社保卡
                </button>
