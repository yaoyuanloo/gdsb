                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            ...
                            <tr>
                                <th width="80">实际医疗费</th>
                                <td></td>
                                <th width="80">核准医疗费</th>
                                <td></td>
                                <th width="80">分摊医疗费</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">生育医疗费用报销</th>
                                <td></td>
                                <th width="80">生育保险个人按比例支付</th>
                                <td></td>
                                <th width="80">个人支付金额</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">生育津贴天数</th>
                                <td></td>
                                <th width="80">生育津贴标准</th>
                                <td></td>
                                <th width="80">生育津贴</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">生育保险支付合计</th>
                                <td></td>
                                <th width="80"></th>
                                <td></td>
                                <th width="80"></th>
                        ...
                        <center>
                            <div id="controlForm" class="form-search breadcrumb" style=" margin: 0; border: 0;">
                                <ul class="ul-form" style="">
                                    <li><label for="backtype">报销类别：</label>
                                        <select id="backtype" name="backtype" class="input-medium selectWidth">
                                    ...
                                    <li>
                                        <label for="sqr1">其他报销额:</label>
                                        <input id="sqr1" name="dnh" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                    <li>
                                        <label for="babynum">胎儿数:</label>
                                        <input id="babynum" name="babynum" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                    <li><label for="yearcalc">是否纳入年度清算：</label>
                                        <select id="yearcalc" name="yearcalc" class="input-medium selectWidth">
