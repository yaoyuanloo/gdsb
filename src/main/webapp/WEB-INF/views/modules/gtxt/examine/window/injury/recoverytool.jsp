                        ...
                        <center>
                            <div id="controlForm" class="breadcrumb form-search" style=" margin: 0; border: 0;">
                                <ul class="ul-form" style="">
                                    <li>
                                        <label>安装及维修医院：</label>
                                        <sys:treeselect id="installhospital" name="installhospital.code" value="${work.fenqu.code}"
                                                        labelName="installhospital.name"
                                                        labelValue="${work.fenqu.name}" notAllowSelectParent="false"
                                                        title="安装及维修医院" url="/xq/area/treeData" cssClass="input-small"
                                                        cssStyle="width: 105px;"
                                                        allowClear="true"/>
                                    </li>
                                    <li>
                                        <label>康复医院：</label>
                                        <sys:treeselect id="recoveryhospital" name="recoveryhospital.code" value="${work.fenqu.code}"
                                                        labelName="recoveryhospital.name"
                                                        labelValue="${work.fenqu.name}" notAllowSelectParent="false"
                                                        title="康复医院" url="/xq/area/treeData" cssClass="input-small"
                                                        cssStyle="width: 105px;"
                                                        allowClear="true"/>
                                    </li>
                                    <li><label for="sqr">器具项目：</label>
                                        <select id="sqr" name="sqr" class="input-medium selectWidth">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
                                    </li>
                                    <li><label for="sqr">康复器具：</label>
                                        <select id="sqr" name="sqr" class="input-medium selectWidth">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                        </select>
                                    ...
                                    <li>
                                        <label for="sqr5">器具数量：</label>
                                        <input id="sqr5" name="sqr5" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                    <li>
                                        <label for="sqr5">票据单据：</label>
                                        <input id="sqr5" name="sqr5" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                    <li>
                                        <label for="sqr5">康复器具费：</label>
                                        <input id="sqr5" name="sqr5" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                    <li>
                                        <label for="sqr5">社保支付合计：</label>
                                        <input id="sqr5" name="sqr5" type="text" htmlEscape="false" maxlength="50"
                                               class="input-medium inputWidth"/>
                                    </li>
                                </ul>
