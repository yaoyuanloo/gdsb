            ...
            <div class="accordion-group">
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            <tr>
                                <th colspan="6" style="text-align: center">更改前标准</th>
                            </tr>
                            <tr>
                                <th width="80">本人工资</th>
                                <td></td>
                            ...
                            <tr>
                                <th width="80">一次性医疗补助计发月数</th>
                                <td></td>
                                <th width="80">一次性伤残补助计发月数</th>
                                <td></td>
                                <th width="80">安家补助计发月数</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">一次性医疗补助计发金额</th>
                                <td></td>
                                <th width="80">一次性伤残补助计发金额</th>
                                <td></td>
                                <th width="80">安家补助计发金额</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">定期开始年月</th>
                                <td></td>
                                <th width="80">定期结束年月</th>
                                <td></td>
                                <th width="80">定期伤残津贴</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">护理费</th>
                                <td></td>
                                <th width="80">一次性支付合计</th>
                                <td></td>
                                <th width="80">鉴定伤残等级</th>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th colspan="6" style="text-align: center">更改后标准</th>
                            </tr>
                            <tr>
                                <th width="80">本人工资</th>
                                <td></td>
