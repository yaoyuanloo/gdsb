            ...
            <div class="accordion-group">
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            <tr>
                            <th colspan="4" style="text-align:center">核定信息修改</th>
                            </tr>
                            <tr>
                                
                                <th width="80">失业证号</th>
                                <td><input type="text" value="" class="input-medium inputWidth"></td>
                                <th width="80">联系电话</th>
                                <td><input type="text" value="" class="input-medium inputWidth"></td>
                            ...
                            <tr>
                                <th width="80">劳动关系终止时间</th>
                                <td><input type="text" value="" class="input-medium inputWidth"></td>
                              
                                <th width="80">失业原因</th>
                                <td><select style="width: 150px;">
							    <option value="" selected="selected">非自愿</option>
							    <option value="" >自愿</option>
					           </select>
                            ...
                            <tr>
                                <th width="80">求职补贴标准</th>
                                <td colspan="3"><input type="text" value="" class="input-medium inputWidth"></td>
                              
                            </tr>
                            <tr>
                                <th width="80">备注</th>
                               
                                <td colspan="3"><textarea rows="2" style="overflow-y:scroll;width:98%;resize:none;"></textarea></td>
                            </tr>
                        </table>
                    </div>
                </div>
