                    ...
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            ...
                            <tr>
                                ...
                                <td>
                                   <input name="startmoneyDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/>
                                ...
                                <td>
                                   <input name="startcountDate" type="text" readonly="readonly"
                                                  maxlength="20" class="input-mini Wdate"
                                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                                                  style="width: 150px;"/>
                            ...
                            <tr>
                                ...
                                <th width="80">在本地缴费起始时间:</th>
                                <td></td>
                                <th width="80">本地实际缴费月数:</th>
                                <td></td>
                                <th width="80">全部实际月数:</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">视同缴费月数合计:</th>
                                <td></td>
                                <th width="80"> 1993年低前实际缴费月数:</th>
                                <td></td>
                                <th width="80">视同建账基数:</th>
                                <td></td>
                                 <th width="80">视同建账群体类别:</th>
                                <td></td>
                            </tr>
             ...
             <div class="accordion-group">
                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            <tr>
                                <th width="80" colspan="2">个人账户基金存储:</th>
                                
                                <th width="80" colspan="4">视同缴费账户存储额:</th>
                            
                                <th width="80" colspan="2">地方养老金存储额:</th>
                                
                                 <th width="80" rowspan="2">有省外转入的统筹基金转移额:</th>
                               
                                <th width="80" rowspan="2">转移基金总数:</th>
                               
                            </tr>
                            <tr>
                                <th width="80">本金(统筹时间前):</th>
                                <th width="80">利息:</th>
                                <th width="80">本地补计额:</th>
                                <th width="80">本地补齐额:</th>
                                <th width="80">异地转入额:</th>
                                <th width="80">利息:</th>
                                <th width="80">本地计算额:</th>
                                <th width="80">异地转入额:</th>
