                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner " style="padding: 0;text-align: center;">
                       <table id="contentTable"
						...
						<thead>
						       <tr>
								<th colspan="4" style="text-align: center;">失业信息</th>
							</tr>
							<tr>
							<td>待遇领取开始结束年月</td>
			                <td></td>
							...
							<tr>
								<th colspan="4" style="text-align: center;">待遇核定信息</th>
							</tr>
							<tr>
								<td >业务类型</td>
								<td></td>
							...
							<tr>
								<td colspan="3">结转月数</td>
							</tr>
							<tr>
								<td colspan="3">实际支付金额</td>
							</tr>
							</thead>
					</table>
