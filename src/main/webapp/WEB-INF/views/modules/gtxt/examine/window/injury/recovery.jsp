                    ...
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            <tr>
                                ...
                                <td></td>
                                <th width="80">是否市外转诊</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">发票数</th>
                                <td></td>
                                <th width="80">医疗费用总金额</th>
                                <td></td>
                                <th width="80">医疗费用不符合支付金额</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">医疗费用社保支付合计</th>
                                <td></td>
                                <th width="80">伙食补贴</th>
                                <td></td>
                                <th width="80">往返交通费</th>
                                <td></td>
                            </tr>
                            <tr>
                                <th width="80">转入地交通食宿费</th>
                                <td></td>
                                <th width="80"></th>
                                <td></td>
                                <th width="80"></th>
...
<script type="text/javascript">
    function fapiao(){
        top.$.jBox.open("iframe:${ctx}/gtxt/utils/util/fapiao?type=injury&qingdan=${type}", "发票录入或修改", 1000, 600, {
            loaded: function () {
                closeTip();
