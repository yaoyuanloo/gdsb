                ...
                <div id="collapseOne" class="accordion-body collapse in">
                    <div class="accordion-inner" style="padding: 0;">
                        <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
                            ...
                            <tr>
                                <th width="80">失业转出社保机构名称:</th>
                                <td width="150"></td>
                                <th width="80">失业缴费凭证编码:</th>
                                 <td width="150" ></td>
                
                            </tr>
                             <tr>
                                <th width="80">失业转出社保机构详细地址:</th>
                             ...
                             <tr>
                                <th width="80">养老转出地记政区划代码:</th>
                                <td width="150" colspan="3"></td>
                               
                
                            </tr>
                            <tr>
                                <th width="80">失业转出地及行政区划代码:</th>
                                <td width="150" colspan="3"></td>
