		 ...
		 <!--  <div class="breadcrumb" style="margin-top: 3px; margin-right: 10px;"> -->
		  <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
              ...
              <table class="table table-striped table-bordered table-condensed" style="margin: 0;">
               ...
               <th colspan="6"  style="text-align: center;"><h5>养老个人账户结算信息</h5></th>
                <tr>
                    <th width="80">公民省份号码:</th>
                    <td width="250"></td>
                    <th width="80">姓名:</th>
                    <td></td>
                    <th width="80">姓名:</th>
                ...
                <tr>
                    <th width="80">个人缴费本金:</th>
                    <td></td>
                    <th width="80">个人缴利息:</th>
                    <td></td>
                    <th width="80">缴费月数:</th>
                    <td></td>
                ...
                <tr>
                    <th width="80">单位划金额:</th>
                    <td></td>
                    <th width="80">单位划利息:</th>
                    <td></td>
                    <th width="80">视同缴费月数:</th>
                    <td></td>
                ...
                <tr>
                    <th width="80">个人账户余额:</th>
                    <td></td>
                    <th width="80">应发放金额:</th>
                    <td colspan="3"></td>
                ...
                <tr>
                    <th width="80">操作员:</th>
                    <td ></td>
                    <th width="80">社保机构意见:</th>
                    <td colspan="3"></td>
                 
                </tr>
                 <tr>
                    <th width="80">代办人姓名:</th>
                    <td ></td>
                    <th width="80">代办人省份证:</th>
                    <td colspan="3"></td>
