                        ...
                        <center>
                            ...
                            <div style="padding: 0; ">
                                    <table class="table table-striped table-bordered table-condensed">
                                       ...
                                       <tr>
                                           <td style="text-align:center;">  <button type="button" id="ywbanjie" onclick="yewubanjie()" class="btn btn-warning"
                                                        style="width: 150px;"><i
                                                   class="icon-cloud-upload"></i>&nbsp; 打印核定单
                                           </button></td>
                                        </tr>
