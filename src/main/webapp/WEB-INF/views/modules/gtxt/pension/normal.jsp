						...
						<div id="centerDiv" class="breadcrumb form-search"
							...
							<center>
								...
								<div id="controlForm" class="breadcrumb form-search"
									...
									<ul class="breadcrumb" style="height: 25px;">

                                      <li > <label for="sqr">一般人员建账方式：</label>
										
										<select  
											id="jzfs" name="jzfs" class="input-medium selectWidth">
										...
										<!-- <li style="margin-left: 50px;">
										   <h5 style="line-height: 30px;"><label for="sqr">一般人员建账方式：</label> </h5></li>
										<li style="margin-left: 10px; line-height: 50px;">
										<select  
											id="jzfs" name="jzfs" class="input-medium selectWidth">
									...
									<li class="daibanren" style="display: none;">
									 ...
									 <input id="ywlsh" name="ywlsh"
										type="text" htmlEscape="false" maxlength="50"
										class="input-medium inputWidth" /></li>
									...
									<li><label>视同截至时间点：</label> 
									   <input name="cjsj" type="text"
										...
										<%-- <li style=""> <h5 style="line-height: 30px;"> 视同截至时间点：</h5>
										<li style="margin-left: 10px; line-height: 30px;"><input
									...
									<li ><label>视同起始时间点：</label>
										...
										<input id="endDate"
											...
											onclick="WdatePicker({dateFmt:'yyyy-MM',isShowClear:true});"
											style="width: 150px;" /></li>
										<%-- <li style=""><h5 style="line-height: 30px;">视同结束时间点</h5>
										</li>
										<li style="margin-left: 10px; line-height: 30px;"><input id="endDate"
											name="cjsj" type="text" readonly="readonly" maxlength="20"
											class="input-mini Wdate"
											value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM"/>"
											onclick="WdatePicker({dateFmt:'yyyy-MM',isShowClear:true});"
