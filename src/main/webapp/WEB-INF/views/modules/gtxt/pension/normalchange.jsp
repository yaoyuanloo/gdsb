            ...
            <center>
                 <div id="controlForm" class="breadcrumb form-search"
									...
									<ul class="breadcrumb" style="height: 30px;">
                                      ...
                                      <li > <label for="normaljz">一般人员建账方式：</label>
										<select  
											id="jzfschage" name="jzfschage" class="input-medium selectWidth">
									...
									<li class="contenttype" style="display: none;"><label>视同截至时间点：</label> 
									   <input name="contenttype" type="text"
									...
									<li class="contenttype" style="display: none;"><label>调出地 ：</label>
