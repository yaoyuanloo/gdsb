    ...
    <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
        ...
        <form id="infoForm" method="post" class="form-search breadcrumb" style=" margin: 0; border: 0;">
            <ul class="ul-form">
                ...
                <li>
                    <label>单位编号：</label>
                    <input name="dwbh" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label>参保人身份证：</label>
                    <input name="sfzh" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label>参保人姓名：</label>
                    <input name="xm" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li class="clearfix"></li>
                <li>
