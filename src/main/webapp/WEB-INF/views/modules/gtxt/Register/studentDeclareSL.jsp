            ...
            <div id="searchForm" action="${ctx}/slzt/slinfo/list" method="post"
                ...
                <ul class="ul-form" >
                 <li ><label for="sqr">申请人：</label>
                    ...
                    <li >
                        <label>单位编号：</label>
                        <input id="hujibh" name="hjbh" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="clearfix"></li>
                    <li >
                        <label style="width:145px;margin-left:-30px;"><font color="blue">参保人身份证号码</font></label>
                        <input id="hujibh" name="hjbh" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="clearfix"></li>
                    <li >
                        <label><font color="blue">参保人姓名</font></label>
                        <input id="hujibh" name="hjbh" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="clearfix"></li>
