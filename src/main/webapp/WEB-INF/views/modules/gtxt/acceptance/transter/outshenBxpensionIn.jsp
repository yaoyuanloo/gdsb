    ...
    <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
        ...
        <form id="infoForm" method="post" class="form-search breadcrumb" style=" margin: 0; border: 0;">
            <ul class="ul-form">
                ...
                <li>
                    <label for="idcard">个人身份证号：</label>
                    <input id="idcard" name="idcard" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label for="sname">个人姓名：</label>
                    <input id=""sname"" name=""sname"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label for="othercl">其他申报材料：</label>
                    <input id=""othercl"" name=""othercl"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li class="clearfix"></li>
                <li>
                    <label for="transtersummoney">转入总金额：</label>
                    <input id="transtersummoney" name="transtersummoney" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
