      ...
      <div class="box box-default" style="margin-top: -20px;"> 
	         ...
	         <div class="box-body">
                    <form class="form-horizontal" name="myform" id="myform" method="post" action="">
                        ...
                        <div class="form-group">
                             <label class="span2 control-label">个人身份证号：</label>
                              <div class="span4">
	                                <input type="text" placeholder="请输入个人身份证" class="form-control" name="" id=""/>
                             </div>
                             
                             <label class="span2 control-label">个人姓名：</label>
                              <div class="span4">
	                                <input type="text" placeholder="请输入个人姓名" class="form-control" name="" id=""/>
                             </div>
                        </div>
                         <div class="form-group">
                            <label class="span2 control-label">其他申报材料：</label>
                              <div class="span4">
	                                <input type="text" placeholder="请输入其他申报材料" class="form-control" name="" id=""/>
                             </div>
                             
                             <label class="span2 control-label">转入总金额：</label>
                              <div class="span4">
	                                <input type="text" placeholder="请输入转入总金额" class="form-control" name="" id=""/>
                             </div>
                        </div>
                        <div class="form-group">
