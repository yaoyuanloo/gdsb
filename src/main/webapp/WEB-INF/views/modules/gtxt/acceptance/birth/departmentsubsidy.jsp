...
<div id="">
    <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
        ...
        <div id="searchForm" class="form-search breadcrumb" cssStyle=" margin: 0; border: 0;">
            <ul class="ul-form">
                <li>
                    <label for="invoicenum" style="width: 140px;">生育医疗报销受理号：</label>
                    <input id="invoicenum" name="invoicenum" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li style="width: 279px;"><label for="sqr">报销费用区域：</label>
                    <label class="checkbox inline" style="width: 50px; line-height: 16px;">
                        <input type="checkbox" value="1" style="margin-top: -1px;"/>境内
                    </label>
                    <label class="checkbox inline" style="width: 50px; line-height: 16px;">
                        <input type="checkbox" value="2" style="margin-top: -1px;"/>境外
                    </label>
                </li>
                ...
                <li class="clearfix"></li>
                <li><label for="ldht">解除劳动合同：</label>
                    <select id="ldht" name="ldht" class="input-medium selectWidth">
                        <option value="0">未解除劳动合同</option>
                        <option value="1">解除劳动合同</option>
                    </select>
                </li>
                <li>
                    <label>选择银行：</label>
                ...
                <li><label for="ldht">申领津贴类型：</label>
                    <select id="ldht" name="ldht" class="input-medium selectWidth">
                ...
                <li class="clearfix"></li>
                <li><label for="deathsign">死亡标志：</label>
                    <select id="deathsign" name="deathsign" class="input-medium selectWidth">
                        <option value="0">未死亡</option>
                        <option value="1">死亡</option>
                    </select>
                </li>
                <li class="deathdate" style="display: none;"><label>死亡日期：</label>
                    <input name="starthospitaldate" type="text" readonly="readonly"
                           maxlength="20" class="input-mini Wdate"
                           value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                           onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
...
<script>
    $(document).ready(function () {
        ...
        $("#deathsign").change(function () {
            if ($(this).val() == 1)
                $(".deathdate").fadeIn('fast');
            else
                $(".deathdate").fadeOut('fast');
        });
    });
