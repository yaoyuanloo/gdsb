    ...
    <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
        ...
        <form id="infoForm" method="post" class="form-search breadcrumb" style=" margin: 0; border: 0;">
            <ul class="ul-form">
                ...
                <li>
                <label for="applyhj" >申请人户籍：</label>
                    <select id="""applyhj"" name="""applyhj""" class="input-medium selectWidth">
                ...
                </div><li class="clearfix"></li>
                
                 <li><label for="linkOutWhere">关系转出地：</label>
                    <select id=""linkOutWhere"" name=""linkOutWhere"" class="input-medium selectWidth">
                        <option value="0">请选择</option>
                        
                    </select>
                    <label for="shen">省</label>
                    
                    
                    <select id=""shenWhere" name=""shenWhere"" class="input-medium selectWidth">
                        <option value="0">请选择</option>
                        
                    </select><label for="shen">市</label>
                    <select id=""xianWhere"" name=""xianWhere"" class="input-medium selectWidth">
                        <option value="0">请选择</option>
                        
                    </select><label for="shen">县</label>
                 </li>
              <!--   <li><label for="shen">省</label></li> -->
               ...
               <!--   <li>
                ...
                <li>
                    <label for="codeYZ">邮政编码：</label>
                    <input id="codeYZ" name="codeYZ" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                 <li class="clearfix"></li>
                 
                 <li>
                    <label for="cbcode">参保凭证号：</label>
                    <input id="cbcode" name="cbcode" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label for="sbOraName">社保机构名称：</label>
                    <input id=""sbOraName"" name=""sbOraName"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
                    <label for="sbOraWhere">社保机构地址：</label>
                    <input id=""sbOraWhere"" name=""sbOraWhere"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                <li class="clearfix"></li>
               ...
               <%--    <li>
                    <label for="applyDate">调动时间：</label>
                 ...
                 <li>
                    <label for="linkPep" style="width: 200px;">联系人：</label>
                    <input id=""linkPep"" name=""linkPep"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                <li>
                    <label for="monbelPhone" style="width: 200px;">移动电话：</label>
                    <input id=""monbelPhone"" name=""monbelPhone"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                <li>
                    <label for="unmonbelPhone" style="width: 200px;">固定电话：</label>
                    <input id=""unmonbelPhone"" name=""unmonbelPhone"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
              <li class="clearfix"></li> 
               <!--  <li>
                <label for="transterreason">转入原因:</label>
                    <select id=""transterType" name=""transterType"" class="input-medium selectWidth">
                        <option value="1">目前在我市就业参保</option>
                        <option value="2">我市为申请人的待遇领取地</option>
                         <option value="3">其它原因</option>
                        <option value="4">调入我市工作</option>
               ...
               <li>
                    <label for="codepension" style="width: 200px;">原个人编号(养老)：</label>
                    <input id=""codepension"" name=""codepension"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
               <!--  <li>
                    <label for="yncb" style="width: 220px;">是否曾在转出地机关事业单位参保：</label>
                    <select id=""yncb" name=""yncb"" class="input-medium selectWidth">
                 ...
                 <li>
               <label for="tookMoney" style="width: 200px;">是否需要退款：</label>
                    <select id=""tookMoney" name=""tookMoney"" class="input-medium selectWidth">
                        <option value="1">是</option>
                        <option value="0">否</option>
               ...
               <!-- 
                  ...
                  <li>
               <label for="tookMoney" style="width: 200px;">退款类型：</label>
                    <select id=""tookMoney" name=""tookMoney"" class="input-medium selectWidth">
                        <option value="0">退转入地</option>
                        <option value="1">退本地</option>
                        
                    </select>
                </li>
                
                <li>
                    <label for="hname" style="width: 200px;">开户名：</label>
                    <input id=""hname"" name=""hname"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                
                 <li>
                    <label for="bankname" style="width: 200px;">银行名称：</label>
                    <input id=""bankname"" name=""bankname"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                 <li>
                    <label for="bankcount" style="width: 200px;">银行账号：</label>
                    <input id=""bankcount"" name=""bankcount"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>  -->
                 <li class="clearfix"></li>
                    <li>
