            ...
            <ul class="ul-form">
                ...
                <div class="accordion-heading">
                 ...
                 <li><label for="linkOutWhere">关系转出地：</label>
                    ...
                    <label for="shen">市</label>
                    <select id=" shiWhere" name="xianWhere" class="input-medium selectWidth">
                        <option value="0">请选择</option>
                        
                    </select>
                    <label for="xianWhere" >县</label>
                    <select id="xianWhere" name="xianWhere" class="input-medium selectWidth" style="width: 80px;">
                        <option value="0">请选择</option>
                ...
                <li>
                    <label for="oraCODE">原个人编号：</label>
                    <input id=""oraCODE"" name=""oraCODE"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li> 
                <li class="clearfix"></li>
               </ul>
