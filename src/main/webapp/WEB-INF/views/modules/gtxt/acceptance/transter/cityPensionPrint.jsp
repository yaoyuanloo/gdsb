                ...
                <div class="box-body">
                   <!--  <form class="form-horizontal" name="myform" id="myform" method="post" action="">
                    ...
                    <div class="form-horizontal">
                	   ...
                	   <!-- form-group -->
                	   <div class="form-group">
                          <label class="span2 control-label">本地参保起止时间</label>
                            <div class="span2">
                               <input type="text"  placeholder="请输入本地参保起止时间" class="form-control" name=" " id="aac001s"/>
                            </div>
                            <label class="span2 control-label">本地实际缴费月数</label>
                            <div class="span2">
                                <input type="text"  placeholder="请输入本地实际缴费月数" class="form-control" name=" " id="aac001s"/>
                            </div>                
	                        <label  for="ywlsh" class="span2 control-label">本地个人账户金额</label>
	                        <div class="span2">
	                             <input type="text"  placeholder="请输入本地个人账户金额" class="form-control" name=" " id="aac001s"/>
	                         </div>
                	      </div>
                        </div> 
                    </div>
