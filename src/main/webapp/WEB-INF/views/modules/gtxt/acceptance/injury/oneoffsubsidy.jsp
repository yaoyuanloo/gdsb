...
<html>
<head>
    <title>医疗业务-一次性医疗补助金业务-受理</title>
...
<body>
    <div id="">
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" class="form-search breadcrumb" style=" margin: 0; border: 0;">
                <ul class="ul-form">
                    ...
                    <li><label>工伤鉴定等级：</label>
                        <select id="injurygrade" name="injurygrade" class="input-medium selectWidth">
                            <option value="1">1级</option>
                            <option value="2">2级</option>
                        </select>
                    </li>
                    <li><label>辞职日期：</label>
                        <input name="turnawaydate" type="text" readonly="readonly"
