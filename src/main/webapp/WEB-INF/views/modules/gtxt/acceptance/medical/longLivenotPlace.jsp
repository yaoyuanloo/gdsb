                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td colspan="5">
                        <ul class="nav nav-pills" style="margin-bottom: 0;">
                            <c:choose>
                                <c:when test="${operateMultiLabel}">
                                    <c:forEach items="${operatetypes}" var="o">
                                        <li>
                                            <a href="javascript:void(0);" class="multiBox" value="${o.id}"
                                               onclick="checkMultiLabel(this, '#baseTable')">
                                                <i class="multiBoxIcon icon-check-empty"></i>
                                                <span class="multiBoxLabel">${o.name}</span>
                                            </a>
                                        </li>
                                    </c:forEach>
                                </c:when>
        ...
        <form id="infoForm" method="post" class="form-search breadcrumb" style=" margin: 0; border: 0;">
            <ul class="ul-form">
                ...
                <li class="clearfix"></li>
                 ...
                 <%-- <li>
                    <label for="dbrname">代办人姓名：</label>
                    <input id="dbrname" name="dbrname" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                  <li>
                    <label>银行名称：</label>
                ...
                <li>
                    <label for="bankcount">银行账号：</label>
                    <input id=""bankcount"" name=""bankcount"" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/> &nbsp; &nbsp;
                    <button type="button" onclick="tijiao();" class="btn btn-info"
                            style="width: 110px;">
                        <i class="icon-cloud-upload"></i>&nbsp; 读取账号
                    </button>
                           
                </li>
                 <li class="clearfix"></li>
                <li><label>在职死亡日期：</label>
                    <input name="moneyenddate" type="text" readonly="readonly"
               ...
               <%--  <li class="clearfix"></li>
                <li>
                    ...
                    <input id="invoicenum" name="invoicenum" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/> yyyy-mm-dd
                </li>
                <li>
                    <label>选择医院：</label>
                    <sys:treeselect id="hospital" name="hospital.code" value="${hospital.code}"
                                    labelName="hospital.name" labelValue="${hospital.name}"
                                    notAllowSelectParent="false" title="医院" url="/xq/area/treeData"
                                    cssClass="input-small" cssStyle="width: 105px;" allowClear="true"/>
                </li> --%>
                <li class="clearfix"></li>
                <li>
