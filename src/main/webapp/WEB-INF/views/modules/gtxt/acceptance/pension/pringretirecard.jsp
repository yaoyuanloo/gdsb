    ...
    <div class="row">
        <div class="span12">
            <div class="bs-callout bs-callout-info" style=" padding: 5px; margin: 0 0 10px 0; line-height: 30px;">
                <div class="row">
                    <div class="span2">
                        <span class="navbar-brand">打印退休证</span>
                    </div>
                    <div class="span10">
                        <form class="navbar-form navbar-right" role="search">
                            <div class="form-group">
                ...
                <div class="box-body">
                    <form class="form-horizontal" name="myform" method="post" action="">
                        <div class="form-group">
                            ...
                            <label class="col-xs-1-5 control-label">打印标识：</label>
                            <div class="span2">
                                <select name="content" class="form-control selectpicker">
                            ...
                            <div class="span2">
                                <input type="text" placeholder="请输入证件号" class="form-control" name="aab004" id="aab004"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-1-5 control-label">离退休日期：</label>
                            <div class="span2 input-group date form_date" data-date="" data-date-format="" data-link="" data-link-format="yyyy-MM-dd">
                            ...
                            <label class="col-xs-1-5 control-label">单位名称：</label>
                            <div class="span2">
                                <input type="text" placeholder="请输入单位名称" class="form-control" name="aab004"
                                       id="aab004"/>
                            </div>
                            <div class="span1"></div>
                            <div class="span3">
