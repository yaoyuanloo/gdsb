...
<html>
<head>
    <title>医疗业务-未就业配偶孕产费用报销业务-受理</title>
    ...
    <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
        ...
        <div id="searchForm" class="form-search breadcrumb" cssStyle=" margin: 0; border: 0;">
            <ul class="ul-form">
                ...
                <li><label for="outcity">报销类型：</label>
                ...
                <li class="clearfix"></li>
                <li class="">
                    <label for="dnh">发票数量：</label>
                    <input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li class="">
                    <label for="dnh">发票金额：</label>
                    <input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li class="">
                    <label for="dnh">确认总金额：</label>
                    <input id="dnh" name="dnh" type="text" htmlEscape="false" maxlength="50"
                           class="input-medium inputWidth"/>
                </li>
                <li>
