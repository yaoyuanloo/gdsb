    ...
    <div class="row">
        <div class="span12">
            ...
            <div class="box box-default">
                ...
                <!-- box-body -->
                <div class="box-body">
                    <form class="form-horizontal" name="myform" id="myform" method="post" action="${ctx}/wx/WXCompany/dajydjsave">
                        ...
                        <div class="form-group">
                            <label class="span2 control-label"><b class="mr5 red500">*</b>借档日期：</label>
                            <div class="span4">
                                <div class="input-group date form_date" data-date="" data-link-field="bee015"
                                     data-link-format="yyyy-mm-dd">
                                    <input class="form-control" readonly="readonly" placeholder="请输入借档日期" name="bee015" id="bee015" size="18" type="text" value="">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 span10">
                                <button type="submit" class="btn yellow">借阅(S)</button>
