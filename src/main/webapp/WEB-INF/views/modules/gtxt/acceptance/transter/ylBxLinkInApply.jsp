            ...
            <div class="box box-default">
                    ...
                    <div class="form-horizontal">
                	    ...
                	    <div class="form-group">
                	       <label  for="ywlsh" class="span2 control-label">单位类型</label>
	                        ...
	                        <div class="span2">
	                           <input type="text" placeholder="请输入单位编号" class="form-control" name="" id=""/>
	                        </div>
                	      ...
                	      <!-- form-group start -->
                	     <div class="form-group">
                	       <label  for="ywlsh" class="span2 control-label">医疗人员类别</label>
	                        <div class="span2">
	                            <select    class="form-control selectpicker">
	                        ...
	                        <label class="span2 control-label">户口性质</label>
	                        <div class="span2">
	                           <select    class="form-control selectpicker">
                                    <option value="0">请选择</option>
                                    <option value="1">。。。。</option>
                            ...
                            <label class="span2 control-label">联系地址</label>
                            <div class="span2">
                               <input type="text"  placeholder="请输入联系地址" class="form-control" name=" " id="aac001s"/>
                            </div>  
                	      </div>
                	       <!-- form-group end -->
                	          <!-- form-group start -->
                	     <div class="form-group">
                	       <label  for="ywlsh" class="span2 control-label">邮政编码</label>
	                        <div class="span2">
	                           <input type="text"  placeholder="请输入联系电话" class="form-control" name=" " id="aac001s"/>
	                         </div>
             ...
             <div class="box box-default">
                  <ul id="myTab" class="nav nav-tabs">
			            <li class="active"><a href="#YWCL" data-toggle="tab">社保机构信息</a></li>
			            <li><a href="#YWCXBQ09" data-toggle="tab">个人参保信息</a></li>
			       </ul> 
	               <div id="myTabContent" class="tab-content">
			            ...
			            <div class="tab-pane active" id="YWCL">
		                    ...
		                    <!-- form-group -->
		                         <div class="form-group">
		                           ...
		                           <div class="span2">
		                            ...
		                            <label class="span2 control-label">原参保地社保机构名称</label>
		                           <div class="span2">
		                               <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                            <label class="span2 control-label">原个人编码</label>
		                           <div class="span2">
		                                   <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>     
		               	       </div> 
		               	       <!-- form-group -->
		                         <div class="form-group">
		                          <label class="span2 control-label">原参保地医疗保险险种类型</label>
		                           <div class="span2">
		                              <select    class="form-control selectpicker">
		                                    <option value="0">请选择</option>
		                                    <option value="1">......</option>
		                           ...
		                           <label class="span2 control-label">原参保地地区名称</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                         ...
		                         <div class="form-group">
		                          <label class="span2 control-label">原社保机构联系电话</label>
		                           ...
		                           <label class="span2 control-label">元社保机构邮政编码</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		               	       </div>   
		                   ...
		                   <div class="box box-default">
		                    ...
		                    <!-- form-group -->
		                         <div class="form-group">
		                           <label class="span3 control-label">新就业地社保机构开户全称</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                            <label class="span3 control-label">新就业地社保机构开户银行行号</label>
		                           <div class="span2">
		                               <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		               	       ...
		               	       <!-- form-group -->
		                         <div class="form-group">
		                           <label class="span3 control-label">新就业地社保机构开户银行名称</label>
		                           <div class="span2">
		                                   <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                          <label class="span3 control-label">新就业地社保机构银行账号</label>
		                           <div class="span2">
		                              <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                        </div>
		                       <!-- form-group -->
		                         <div class="form-group">
		                           <label class="span3 control-label">新就业地社保机构地址</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                           <label class="span3 control-label">新就业地社保机构邮政编码</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		               	       </div>     
		               	        <!-- form-group -->
		                         <div class="form-group">
		                          <label class="span3 control-label">新就业地社保机构名称</label>
		                           <div class="span2">
		                               <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		                           <label class="span3 control-label">新就业地社保机构联系电话</label>
		                           <div class="span2">
		                                <input type="text" class="form-control" name=" " id="aac003"/>
		                           </div>
		               	       </div>   
