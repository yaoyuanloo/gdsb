                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                         <label class="span2 control-label">性别</label>
                          ...
                          <label class="span2 control-label">出生日期</label>
                            <div class="span2">
                               <input type="text"  placeholder="请输入出生日期" class="form-control" name=" " id="aac001s"/>
                            </div>
                            <label class="span2 control-label">户口所在地详细地址</label>
                            <div class="span2">
                                <input type="text"  placeholder="请输入详细地址" class="form-control" name=" " id="aac001s"/>
                            </div>                
	                    
                	    </div>
               	       <!-- form-group -->
               	       <div class="form-group">                	     
                            <label class="span2 control-label">重复缴费人员标志</label>
                            <div class="span2">
                                <select    class="form-control selectpicker">
	                        ...
	                        <label  for="ywlsh" class="span2 control-label">参保人银行账号</label>
	                        <div class="span2">
	                             <input type="text"  placeholder="请输入银行账号" class="form-control" name=" " id="aac001s"/>
	                         </div>
	                       
	                        <label class="span2 control-label">参保人开户全称</label>
	                        <div class="span2">
	                           <input type="text"  placeholder="请输入开户全称" class="form-control" name=" " id="aac001s"/>
	                        </div>
                	   </div>
                	   <!-- form-group -->
                	   <div class="form-group">
                          <label class="span2 control-label">参保人开户银行名称</label>
                            <div class="span2">
                               <select class="form-control selectpicker">
                                    <option value="0">请选择</option>
                                    <option value="1">......</option>
                            ...
                            <label class="span2 control-label">单位编号</label>
                            <div class="span2">
                                <input type="text"  placeholder="请输入单位编号" class="form-control" name=" " id="aac001s"/>
                            </div>                
	                        <label  for="ywlsh" class="span2 control-label">单位名称</label>
	                        <div class="span2">
                	      ...
                	      <!-- form-group -->
                	   <div class="form-group">
                          <label class="span2 control-label">单位类型</label>
                            <div class="span2">
                               <select class="form-control selectpicker">
                                    <option value="0">请选择</option>
                                    <option value="1">......</option>
             ...
             <!-- 标签 start -->
              ...
              <!-- 标签 end -->
                ...
                <div class="box-body">
                    ...
                    <!-- form-group -->
                         <div class="form-group">
                           <label class="span2 control-label">转出地社保机构行政区划分码</label>
                           <div class="span2">
                               <select class="form-control selectpicker">
                                    <option value="0">请选择</option>
                                    <option value="1">......</option>
                            ...
                            <label class="span2 control-label">转出地社保机构名称</label>
                           <div class="span2">
                               <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                            <label class="span2 control-label">转出地个人编号</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
               	       ...
               	       <!-- form-group -->
                         <div class="form-group">
                          <label class="span2 control-label">转出地社保机构联系电话</label>
                           <div class="span2">
                              <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                           <label class="span2 control-label">转出地社保机构邮政编码</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                           <label class="span2 control-label">转出地社保机构地址</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
               	       </div>      
              ...
              <!-- 标签 end -->
                ...
                <div class="box-body">
                    ...
                    <!-- form-group -->
                         <div class="form-group">
                           <label class="span2 control-label">转入地行政区划分码</label>
                           <div class="span2">
                              <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                            <label class="span2 control-label">转入地社保机构名称</label>
                           <div class="span2">
                               <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                            <label class="span2 control-label">转入地社保机构开户全称</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
               	       ...
               	       <!-- form-group -->
                         <div class="form-group">
                          <label class="span2 control-label">转入地社保机构开户银行名称</label>
                           <div class="span2">
                              <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                           <label class="span2 control-label">转入地社保机构银行账号</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
                           <label class="span2 control-label">转入地社保机构联系电话</label>
                           <div class="span2">
                                <input type="text" class="form-control" name=" " id="aac003"/>
                           </div>
               	       </div>      
