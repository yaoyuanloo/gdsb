                    ...
                    <form class="form-horizontal" name="myform" id="myform" method="post" action="">
                        <div class="form-group">
                              ...
                              <div class="span4">
	                               <div class="radio">
								  		<label>
								    		<input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>一般账户
								  		</label>
								  		<label>
								    		<input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">临时账户
								  		</label>
									</div>
                             </div>
                        </div>
                        ...
                        <div class="form-group">
                              <label class="span2 control-label">转移类型：</label>
                              <div class="span4">
	                                <select name="show" class="form-control selectpicker">
	                                    <option value="1">自主流转</option>
                             ...
                             <label class="span2 control-label">户籍地址：</label>
                              <div class="span4">
	                                <input type="text" placeholder="请输入户籍地址" class="form-control" name="" id=""/>
                             </div>
                        </div>
