        ...
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" class="breadcrumb form-search" style=" margin: 0; border: 0;">
                <ul class="ul-form">
                    ...
                    <li><label for="support">是否有供养人：</label>
                        <select id="support" name="support" class="input-medium selectWidth">
                            <option value="0">是</option>
                            <option value="1">否</option>
                        </select>
                    </li>
                    <li><label for="blrlb">代办人类型：</label>
                        <select id="blrlb" name="blrlb" class="input-medium selectWidth">
                            <option value="0">子女</option>
                           
                        </select>
                    </li>
                     <li><label for="child" style="width:100px">有法定继承人：</label>
                        <select id=""child"" name=""child"" class="input-medium selectWidth">
                            <option value="0">是</option>
                            <option value="0">否</option>
                           
                        </select>
                    </li>
                      <li><label for="deathTime">死亡时间按：</label>
                    ...
                    <li class="bankName" style="display: none;">
                        <label for="bankName">银行名称：</label>
                        <input id="bankName" name="bankName" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                     <li class="bankName" style="display: none;">
                        <label for="huName">户名：</label>
                        <input id="huName" name="huName" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="bankName" style="display: none;">
