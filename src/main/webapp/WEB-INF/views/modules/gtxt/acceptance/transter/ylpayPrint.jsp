            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                   <!--  <form class="form-horizontal" name="myform" id="myform" method="post" action="">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                         <label class="span2 control-label">性别</label>
                          ...
                          <label class="span2 control-label">出生日期</label>
                            ...
                            <label class="span2 control-label">医疗人员类别</label>
                            <div class="span2">
                                <select    class="form-control selectpicker">
                	    ...
                	    <div class="form-group">
                	       <label  for="ywlsh" class="span2 control-label">户籍类型</label>
	                        <div class="span2">
	                           <select    class="form-control selectpicker">
                                    <option value="0">请选择</option>
                                    <option value="1">......</option>
                	   ...
                	   <!-- form-group -->
                	   <div class="form-group">
                          <label class="span2 control-label">参保开始时间</label>
                            <div class="span2">
                               <input type="text"  placeholder="请输入参保开始时间" class="form-control" name=" " id="aac001s"/>
                            </div>
                            <label class="span2 control-label">待遇享受开始时间</label>
                            <div class="span2">
                                <input type="text"  placeholder="请输入待遇享受开始时间" class="form-control" name=" " id="aac001s"/>
                            </div>                
	                        <label  for="ywlsh" class="span2 control-label">个人账户余额</label>
	                        <div class="span2">
	                             <input type="text"  placeholder="请输入个人账户余额" class="form-control" name=" " id="aac001s"/>
	                         </div>
                	      </div>
                        </div> 
                    </div>
               ...
               <div class="box box-default">
                  <ul id="myTab" class="nav nav-tabs">
			            <li class="active"><a href="#YWCL" data-toggle="tab">个人参保信息</a></li>
                    ...
                    <!-- form-group -->
                       ...
                       <div class="form-group">
                            <div class="col-sm-offset-2 span10">
                                ...
                                <button type="submit" class="btn gray">打印医疗参保凭证</button>
                            </div>
                        </div>   	       
                     </div> 
                    </div>
