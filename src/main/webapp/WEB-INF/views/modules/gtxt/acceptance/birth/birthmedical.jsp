...
<body>
    <div id="">
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" class="form-search breadcrumb" cssStyle=" margin: 0; border: 0;">
                <ul class="ul-form">
                    ...
                    <li>
                        ...
                        <sys:treeselect id="hospital" name="hospital.code" value="${work.fenqu.code}"
                                        ...
                                        title="银行" url="/xq/area/treeData" cssClass="input-small"
                                        cssStyle="width: 105px;"
                                        allowClear="true"/>
                    </li>
                    <li><label for="ldht">劳动合同：</label>
                        <select id="ldht" name="ldht" class="input-medium selectWidth">
                            <option value="0">不符合提前解除劳动合同</option>
                            <option value="1">符合提前解除劳动合同</option>
                        </select>
                    </li>
                    <li class="clearfix"></li>
                    <li>
                        <label for="invoicenum">发票数：</label>
                        <input id="invoicenum" name="invoicenum" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li>
                        <label for="invoicetotal">发票总金额：</label>
                        <input id="invoicetotal" name="invoicetotal" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="accouchement birthplan" style="display: none;"><label>费用发生日期：</label>
                    ...
                    <div class="accouchement birthplan" style="display: none;">
                        <li><label for="sqr">死亡标志：</label>
                            <select id="sqr" name="sqr" class="input-medium selectWidth">
                                <option value="0">未死亡</option>
                                <option value="1">死亡</option>
                            </select>
                        </li>
                        <li class="death" style="display: none;"><label>死亡日期：</label>
                            <input name="starthospitaldate" type="text" readonly="readonly"
                                   maxlength="20" class="input-mini Wdate"
                                   value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                    ...
                    <li class="clearfix"></li>
                    <li class="accouchement birthcheck" style="display: none;"><label for="birthid">计生证编号：</label>
                        <input id="birthid" name="birthid" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li class="accouchement" style="display: none;"><label for="sqr">合并支付津贴：</label>
                        <select id="sqr" name="sqr" class="input-medium selectWidth">
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </li>
                    <li class="birthcheck" style="display: none;"><label for="firstpay">是否已选定点：</label>
                        <select id="firstpay" name="firstpay" class="input-medium selectWidth">
                            <option value="0">否</option>
                            <option value="1">是</option>
                        </select>
                    </li>
                    <li class="birthcheck" style="display: none;"><label>签约开始时间：</label>
                        <input name="signstartdate" type="text" readonly="readonly"
                               maxlength="20" class="input-mini Wdate"
                               value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                               style="width: 150px;"/>
                    </li>
                    <li class="birthcheck" style="display: none;"><label>产检开始日期：</label>
                        <input name="starthospitaldate" type="text" readonly="readonly"
                               maxlength="20" class="input-mini Wdate"
                               value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
                    ...
                    <li class="birthcheck" style="display: none;"><label>产检结束日期：</label>
...
<script>
    ...
    function showInput(type){
        $(".accouchement").fadeOut(0);
        $(".birthplan").fadeOut(0);
        $(".birthcheck").fadeOut(0);
        if('0' == type){
            $(".accouchement").fadeIn(0);
        }else if('1' == type){
            $(".birthplan").fadeIn(0);
        }else if('2' == type){
            $(".birthcheck").fadeIn(0);
