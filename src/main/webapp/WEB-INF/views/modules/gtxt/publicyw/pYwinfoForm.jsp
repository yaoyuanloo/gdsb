...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/publicyw/pYwinfo/">公共业务信息表列表</a></li>
	<li class="active"><a href="${ctx}/publicyw/pYwinfo/form?id=${pywinfo.id}">公共业务信息表<shiro:hasPermission name="publicyw:pYwinfo:edit">${not empty pYwinfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="publicyw:pYwinfo:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
