...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/publicyw/pConditionCate/">业务条件分类列表</a></li>
		<li class="active"><a href="${ctx}/publicyw/pConditionCate/form?id=${pConditionCate.id}">业务条件分类<shiro:hasPermission name="publicyw:pConditionCate:edit">${not empty pConditionCate.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="publicyw:pConditionCate:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="pConditionCate" action="${ctx}/publicyw/pConditionCate/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="publicyw:pConditionCate:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
