...
<html>
<head>
    <title>失业业务-非广东省户籍人员一次性失业保险金重核-受理</title>
        ...
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" class="breadcrumb form-search" style=" margin: 0; border: 0;">
                <ul class="ul-form">
                    ...
                    <li><label for="liveSapcew">户籍：</label>
                        <select id="liveSapcew" name="liveSapcew" class="input-medium selectWidth">
                    
                            <option value="0">户籍选择</option>
                        </select>
                    </li>
                    <li class="clearfix"></li>
                      <li><label for="unenployeement">失业登记日期：</label>
                         <input name=""unenployeement"" type="text"
										readonly="readonly" maxlength="20" class="input-mini Wdate"
										value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM"/>"
										onclick="WdatePicker({dateFmt:'yyyy-MM-DD',isShowClear:true});"
										style="width: 150px;" /> 
                    </li>
                    <li><label for="notWorklink" style="width:150px;marign-left:-100px;" >劳动关系终止日期：</label>
                         <input name=""notWorklink"" type="text"
										readonly="readonly" maxlength="20" class="input-mini Wdate"
										value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM"/>"
										onclick="WdatePicker({dateFmt:'yyyy-MM-DD',isShowClear:true});"
										style="width: 150px;" /> 
                    </li>
                   <li class="stopWorkreason" style="display: none;">
                        <label for="stopWorkreason">终止原因：</label>
                        <input id="stopWorkreason" name="stopWorkreason" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>
                    <li>
                    <!-- class=" btn btn-primary" -->
                        <label for="stopWorkreason">计算发金额：</label>
                        <input id="stopWorkreason" name="stopWorkreason" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/> &nbsp; 
                          <button type="button" id="tijiao" onclick="" 
                                style="width: 110px;"><i
                                class="icon-cloud-upload"></i>&nbsp; 计算
                        </button>
                    </li>
                    <li class="clearfix"></li>
                    <li>
