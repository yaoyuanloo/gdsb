        ...
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" action="${ctx}/slzt/slinfo/list" method="post"
                 class="breadcrumb form-search" cssStyle=" margin: 0; border: 0;">
                     ...
                     <ul class="ul-form">
                    <li><label for="sqr"  class="blockquote-reverse">申请人：</label>
                    ...
                    <li >
                        <label for="phone"   class="blockquote-reverse">联系电话：</label>
                        <input id="phone" name="phone" type="text" htmlEscape="false" maxlength="50"
                               class="input-medium inputWidth"/>
                    </li>

                    <li class="daibanren blockquote-reverse" style="display: none;" >
                    ...
                    <li>
					<label  >户籍所在地:</label>
					<input   class="input-medium inputWidth" type="text"  htmlEscape="false" maxlength="50"
						value="" />
					</li>
					<li >
					<label  >转移凭证编号:</label>
					<input   class="input-medium inputWidth"  type="text" htmlEscape="false" maxlength="50"
						value="" />
                         ...
                         <li class="clearfix"></li>
					<li>
					<label  style="width:150px;margin-left:-40px;">待遇转入申请受理号:</label>
					<input    type="text" class="input-medium inputWidth"  htmlEscape="false" maxlength="50"
						value="" />
					</li>
                       <li>
                    <label   style="width:150px;margin-left:-40px;">待遇转入申请档案号:</label>
					<input    type="text" class="input-medium inputWidth"  htmlEscape="false" maxlength="50"
						value="" />
					</li>
					...
					<div class="accordion-heading"
						...
						<div style="float: left;">
							<a href="javascript:void(0);" class="accordion-toggle" data-toggle="tooltip"
								data-placement="right" title="">转入地信息 </a>
						</div>
					</div>
			        </div>
			        <ul class="ul-form">
					...
					<select style="width: 150px;">
							<option selected="selected">广西省</option>
					</select>省 <select style="width: 150px;">
							<option selected="selected">梧州市</option>
					</select>市 <select style="width: 150px;">
							<option selected="selected">苍梧县</option>
					</select>县
				    </li>
				    <li class="clearfix"></li>
				    <li>
					<label style="width:150px;margin-left:-40px;">社保经办机构名称:</label>
					<input class="input-medium inputWidth"  type="text" htmlEscape="false" maxlength="50"
						value="" />
					</li>
				   <li class="clearfix"></li>
