        ...
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" action="${ctx}/slzt/slinfo/list" method="post"
                ...
                <div style="margin-top:10px;margin-left:30px;" >
                    <label> 关系转出地:</label>
                    <select class="input-medium inputWidth">
                        <option selected="selected"></option>
                    </select>省 <select class="input-medium inputWidth">
                    <option selected="selected"></option>
                </select>市 <select class="input-medium inputWidth">
                    <option selected="selected"></option>
                </select>县
                </div>
                <div style="margin-top:-20px;margin-left:-1px;" >
                    <ul class="ul-form">
                        <li class="clearfix"></li>
                        <li ><label >邮政编码:</label>
                            <input     class="input-medium inputWidth"  type="text"
                                       value=""/>
                        </li>


                        <li margin-left:80px;><label >社保机构名称:</label>
                            <input  class="input-medium inputWidth"  type="text"
                                    value="" />
                        </li>
                        <li><label>社保机构地址:</label>
                            <input   class="input-medium inputWidth"  type="text"
                                     value="" />
                        </li>
                        <li><label>转移凭证编码:</label>

                            <input   class="input-medium inputWidth"  type="text"
                                     value="" />
                        </li>
                        <li><label>原个人编号:</label>
                            <input   class="input-medium inputWidth"  type="text"
                                     value="" />
                        </li>
                        ...
                        <li>
                            <label>失业转入类型:</label>
                            <a href="javascript:void(0);" class="multiBox" onclick="checkLabel(this)">
                                <i class="multiBoxIcon icon-circle-blank"></i>
                                <span class="multiBoxLabel">手工转入</span>
                                <i class="multiBoxIcon icon-circle-blank" ></i>
                                <span class="multiBoxLabel">电子化转入</span>
