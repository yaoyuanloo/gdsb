        ...
        <div id="centerDiv" style="width: 100%; margin: 0;overflow-x: hidden; overflow-y: auto;">
            ...
            <div id="searchForm" action="${ctx}/slzt/slinfo/list" method="post"
                 class="breadcrumb form-search" cssStyle=" margin: 0; border: 0;">
					...
					<input   class="input-medium inputWidth"
						value="" />
					</li>
				</ul>
					...
					<div class="accordion-heading"
						...
						<div style="float: left;">
							<a href="javascript:void(0);" class="accordion-toggle" data-toggle="tooltip"
								data-placement="right" title="">银行信息 </a>
						</div>
					</div>
			</div>
				<div class="accordion-heading" style="width: 100%;text-align: center;">
                  <div id="dz" style="height: 90px;" >
                        <div style="height: 45px;margin-left: -410px;">
	                          <ul class="breadcrumb">
		                       	<li>
		                          <label for="ywlsh">银行名称:</label>
			                      <select class="input-medium inputWidth">
							      <option selected="selected">请选中</option>
					              </select>
		                        </li>
		                        <li>
		                       		<label for="ywlsh">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;市外银行名称:</label>
			                        <input id="ywlsh" name="ywlsh" type="text" htmlEscape="false" maxlength="50"
			                               class="input-medium inputWidth"/>
		                        </li>
	                          </ul>
                        </div>
                         <div style="height: 45px;margin-left: -400px;">
	                          <ul class="breadcrumb">
		                       	<li  >
		                          <label for="ywlsh"  >&nbsp;&nbsp;&nbsp;&nbsp;户名:</label>
			                      <input id="ywlsh" name="ywlsh" type="text" htmlEscape="false" maxlength="50"
			                               class="input-medium inputWidth"/>
		                        </li>
		                        <li style="margin-left:50px;">
		                       		<label for="ywlsh" >银行账号:</label>
			                        <input id="ywlsh" name="ywlsh" type="text" htmlEscape="false" maxlength="50"
			                               class="input-medium inputWidth"/>
		                        </li>
	                          </ul>
			 ...
			 <div class="accordion-heading" style="width: 100%;text-align: center;">
                  <div id="dz" style="height: 90px;" >
                        <div style="height: 45px;margin-left: -400px;">
	                          <ul class="breadcrumb">
		                       	<li>
		                          <label for="ywlsh">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;失业登记日期(yyyyMMdd):</label>
                        ...
                        <div style="height: 45px;margin-left: -400px;" >
	                          <ul class="breadcrumb">
		                          	<li>
		                       		<label for="ywlsh">劳动关系终止时间(yyyyMMdd):</label>
			                     <input name="starthospitaldate" type="text" readonly="readonly"
                                  maxlength="20" class="input-mini Wdate"
                                  value="<fmt:formatDate value="${work.cjsj}" pattern="yyyy-MM-dd"/>"
                                  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'/*,isShowClear:true*/});"
