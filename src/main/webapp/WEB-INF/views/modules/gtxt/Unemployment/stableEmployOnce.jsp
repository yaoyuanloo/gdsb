...
<html>
<head>
    <title>失业业务-生育加发失业保险金重申-受理</title>
            ...
            <div id="searchForm" class="breadcrumb form-search" style=" margin: 0; border: 0;">
                <ul class="ul-form">
                    ...
                    <li class="clearfix"></li>
                      <li><label for="temployDATE">重新就业时间：</label>
                         <input name=""temployDATE"" type="text"
                     ...
                     <li><label for="birthplace">户籍类型：</label>
                        <select id="birthplace" name="birthplace" class="input-medium selectWidth">
                            <option value="1">市内人员</option>
                            <option value="0">市外人员</option>
                        </select>
                    </li>
