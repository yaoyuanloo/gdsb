...
<head>
	...
	<style type="text/css">
		...
		<c:if test="${cookie.theme.value eq 'flat'}">
		#userControl>li>a{color:#fff;text-shadow:none;} #userControl>li>a:hover, #user #userControl>li.open>a{background:transparent;}
		.navbar-inner{background-color: #00428e; /*background-color: #0e365c; background-image: url("${ctxStatic}/common/header_bg.png");*/ color: white; border: none;}
		#productName{color: white;}
		/*.nav .menu.active{color: white;}*/
		</c:if>
		<c:if test="${! cookie.theme.value eq 'flat'}">
		#userControl>li>a{text-shadow:none;} #userControl>li>a:hover, #user #userControl>li.open>a{background:transparent;}
		</c:if>
		#menu>li>a{color:#fff; text-shadow:none;} #menu>li.active>a{color:#333; background-color: white; text-shadow:none;}
		#left .accordion a, #left .accordion a:hover, #left .accordion a:active{text-decoration: none;}
		/*#left {background-color: #00428e;}
		.accordion .accordion-group .accordion-heading .accordion-toggle{background-color: #0081cc; color: white;} .accordion-group{border: none;}
		!*.accordion-inner .nav  li.active a{color: #FFF;} *!.accordion-inner .nav  li a{color: #FFF;}
		#jerichotab .tab_pages .tabs .tab_unselect{} #jerichotab .tab_pages .tabs .tab_selected{}*/
	</style>
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $.fn.initJerichoTab({
                ...
                uniqueId: 'jerichotab',
                contentCss: {
                    'height': $('#right').height() - tabTitleHeight //设置高度
                },
                tabs: [/*{
                    title: '主页',
                    closeable: false,
                    data: {
                        dataType: 'iframe',
                        dataLink: '${ctx}/sys/user/tohome'
                    }
                }*/],
				activeTabIndex: 0,
                loadOnce: true,
                tabWidth: 110,
                titleHeight: tabTitleHeight	//tabWidth 标签页标题宽度
            });//</c:if>
			// 绑定菜单单击事件Start-----------------------------------------------
...
//					});
			...
			<%--var home = $('<a href="${ctx}/sys/user/tohome" target="mainFrame" ><i class="icon-circle-arrow-right"></i>主页</a>');--%>
			<%--addTab(home);--%>
		});
	...
	<div id="main">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By Fortunes ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript">
