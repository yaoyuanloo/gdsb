...
<body>
	...
	<div align="right">
		<input   class="btn btn-primary" onclick="javascript:window.location.href='${ctx}/ywgl/targets/formTJinfo?jZbdm=${targets.JZbdm}'"  type="button"    value="添加"/>
		<input   class="btn btn-primary" onclick="javascript:window.location.href='${ctx}/ywgl/targets/tjList'"  type="button"    value="返回"/>
  </div>
	<%--<a href="">指标代码表添加</a>--%>
