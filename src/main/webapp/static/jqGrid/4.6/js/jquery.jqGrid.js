...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		formatter = function (rowId, cellval , colpos, rwdat, _act, irow){ // fortunes add irow
			var cm = ts.p.colModel[colpos],v;
			if(cm.formatter !== undefined) {
				rowId = String(ts.p.idPrefix) !== "" ? $.jgrid.stripPref(ts.p.idPrefix, rowId) : rowId;
				var opts= {rowId: rowId, colModel:cm, gid:ts.p.id, pos:colpos, irow:irow }; // fortunes add irow
		...
		addCell = function(rowId,cell,pos,irow, srvr, rdata) {
			var v,prp;
			v = formatter(rowId,cell,pos,srvr,'add',irow); // fortunes add irow
