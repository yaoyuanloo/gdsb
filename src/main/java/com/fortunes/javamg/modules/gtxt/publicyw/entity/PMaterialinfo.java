 ...
 * @version 2016-09-07
 */
public class PMaterialinfo extends DataEntity<PMaterialinfo> {
	
	private static final long serialVersionUID = 1L;
	private String cateId;		// 材料分类
	private String name;		// 材料名称
	private String code;		// 功能代码
	private String conment;		// 内容
	private String state;		// 状态
	
	public PMaterialinfo() {
		super();
	}

	public PMaterialinfo(String id){
		super(id);
	}

	@Length(min=0, max=35, message="材料分类长度必须介于 0 和 35 之间")
