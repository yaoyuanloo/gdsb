...
import com.fortunes.javamg.modules.sys.security.FormAuthenticationFilter;
...
//		}
	...
	/**
	 * 登录失败，真正登录的POST请求由Filter完成 (FormAuthenticationFilter -- com.fortunes.javamg.modules.sys.security.FormAuthenticationFilter)
	 */
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		// 登录成功后，验证码计算器清零
		//isValidateCodeLogin(String.valueOf(principal.getPrimaryPrincipal()), false, true);
...
//		try {
//			byte[] bytes = com.fortunes.javamg.common.utils.FileUtils.readFileToByteArray(
//					com.fortunes.javamg.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
