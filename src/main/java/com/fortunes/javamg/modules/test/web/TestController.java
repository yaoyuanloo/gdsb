 ...
 * 
 */
package com.fortunes.javamg.modules.test.web;
...
import com.fortunes.javamg.modules.test.service.TestService;
...
//		return "redirect:" + adminPath + "/test/test/?repage";
	...
	@RequestMapping(value = "gaopaiyi")
	public String gaopaiyi(Test test, RedirectAttributes redirectAttributes) {
		return "modules/test/gaopaiyi";
	}
}
